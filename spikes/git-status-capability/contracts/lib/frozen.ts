...
export const SCHEMA_DESCRIPTORS = Object.freeze({
  ...
  row_evidence: {
    ...
    field_types: {
      ...
      actual_resource_record: "strict:actual-boundary;LIM=content-addressed-stimulus-and-measurement;non-LIM-launcher-counters=bound-below|exact-pass-or-exceeded-causal-fail;all-measurement-locators=require-platform-equal-row-and-digest-bound;below-none-has-no-proof", source_input_record_sha256: "sha256",
