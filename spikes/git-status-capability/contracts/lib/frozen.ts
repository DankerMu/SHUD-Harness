...
export const INGESTION_LIMITS = Object.freeze({
  ...
  authority_set: { bytes: 256 * 1024, depth: 32, nodes: 32_768, items: 8_192 },
...
export const SUPPLY_IDENTITY = Object.freeze({
  ...
  cargo_cli_release: "1.88.0",
  cargo_commit: "873a06493",
  cargo_package_version: "0.89.0",
  git_version: "2.49.0",
  targets: {
...
export const SCHEMA_DESCRIPTORS = Object.freeze({
  authority_set: {
    schema_version: "shud.git-status-capability.authority-set.v1",
    required_fields: ["schema_version", "source_record", "platforms", "decision", "command_profile"],
    optional_fields: [],
  ...
  platform_bundle: {
    ...
    required_fields: [
      ...
      "lockfile_digest", "rust_toolchain_digest", "toolchain", "target", "dependency_graph_digest", "direct_feature_digest", "call_ledger_digest", "sbom_digest",
  ...
  decision: {
    ...
    required_fields: [
      ...
      "gates", "run_status", "base_sha", "lockfile_digest", "rust_toolchain_digest", "toolchain"
    ],
    optional_fields: ["terminal_decision", "first_cause", "all_failure_codes"],
    additional_properties: false
  },
