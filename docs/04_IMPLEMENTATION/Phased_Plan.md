...
与实施记录 `openspec/changes/m1-foundation`。条 2' 首实现（PR #48）post-gate 复审进一步把遥测/进程所有权收窄为可观测边界（seatbelt 守 raw 字节不变，四条 finding 未击穿完整性）——见 ADR-0001 2026-07-04 裁决补充与账本例外批次 5。
