...
**快照声明 (2026-07-02)**: 本报告基于 d162db3 (v2.2.0)；子模块已同步至 2b7742e (**v2.5.0, 228 导出函数**，新增河道几何校验与 CRS guard)。命令面事实基线见 [Domain_CLI_Spec](../03_SPEC/Domain_CLI_Spec.md) §2.2，本报告全量刷新待办。
