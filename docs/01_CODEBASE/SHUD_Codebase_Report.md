...
**分支**: master (clean)
**语言**: C++14, ~6,875 行源码
**快照声明 (2026-07-02)**: 本报告基于 9b55b0c；子模块已同步至 3aec657 (tag cpu-accel-v1.0.2)。命令行 flag/退出码/输入清单/输出命名的权威事实见 [Domain_CLI_Spec](../03_SPEC/Domain_CLI_Spec.md) §2.1，本报告全量刷新待办。
