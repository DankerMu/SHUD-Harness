...
### Issue #176 binding-aware real-delegate topology overlay

This overlay is the active implementation fixture for #176, the second
replacement child of #172. Fixture level is `expanded`; repair intensity is
`high`; upstream suggestion is `expanded` (agree). The minimal mergeable slice
