...
- `raw-wrapper-post-fix-red.patch`: 891 bytes; SHA-256 `538564d6d6f2e8614da6e251eb724c0a5fc12fe87408f83eee03b06af633ff12`. Result: exit `1`; the `node_fs_readFileSync` row retained the exact denial but reported `raw:node_fs_readFileSync:[replacement-path]`.
